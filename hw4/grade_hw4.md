...
### Completeness, correctness and efficiency of solution: 155/200

- Q1 (95/100)
	- Q1.8 - The html file does not show the table. I had to run the table on my end. The table has lots of extra output (-5)
...
- Q2 (60/100)
	- The app is very nice and well set-up. However, there is a lot of summary and patient information missing.
	The graphs for the patients are not the same as those from Q1 from hw3 (-40)
...
-   Are the materials (files and instructions) submitted to the `main` branch sufficient for reproducing all the results? Just click the `Render` button will produce the final `html`? 
	- Need to connect to database using dbConnect in mimic.R (-5)
