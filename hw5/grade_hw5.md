...
### Overall Grade: 269/300

### Late penalty

Is the homework submitted (git tag time) before deadline? Take 10 pts off per day for late submission.

### Quality of report: 49/50
...
**The summary table is not shown in html/pdf file.** (-1 pt)

### Reproducibility: 50/50

### Compleeness and performance: 70/100
...
**`los` should not be selected as predictor.** (-20 pts)

**Please present the importance of features.** (-5 pts)
