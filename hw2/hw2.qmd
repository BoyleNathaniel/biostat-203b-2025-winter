...
Yes. Read_csv is able to distinguesh data and time formats automatically.
read.csv treats these same columns as "characters." 
Read_csv treates certain columns as "numeric" while read.csv treates them as 
...
(Hint: `system.time` measures run times; `pryr::object_size` measures memory usage; all these readers can take gz file as input without explicit decompression.) 
