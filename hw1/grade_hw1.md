...
- Q3 (18/20)
	...
	**Q3.4: Only report the number of lines in admissions.csv.gz** (-1 pt)
	**Q3.6: Not report the insurance** (-1 pt)
...
**Line 138, 147, 157, 246, 263, 283, 326, 335**
...
**Nice work! Remember set eval=true so that I can see your output.**
